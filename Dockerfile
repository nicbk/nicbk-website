...
# The Garage bootstrap needs no bundling — it imports nothing — but goes to the
# same absolute path for the same reason: outside /app, where the dev bind
# mount cannot hide it.
COPY scripts/garage-init.mjs /usr/local/lib/garage-init.mjs
