...
the view: three lists with counts, in-collection items that open the paper,
outside references as printed with Semantic Scholar links, the credit, and the
empty/incomplete messages.
