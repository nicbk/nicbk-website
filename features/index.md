...
| 3 | Projects page (entry point to Lit Tracker) | [`projects-page`](./projects-page/description.md) | **Implemented**, awaiting PR + CI + review (2026-08-01; 1 task) | #1 |
...
`projects-page` (implemented, in review), and `authentication` (spec'd) have
