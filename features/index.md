...
| 10 | Citation-graph traversal (a Citations tab: what a paper cites and what cites it, followed from paper to paper with a short way back) | [`citation-graph-traversal`](./citation-graph-traversal/description.md) | **In progress** (2026-09-14; 5 tasks; tasks 1–2 merged, task 3 in review) | #7, #9, #23 |
...
`a-paper-opens-where-you-left-it` (complete) and `citation-graph-traversal` (in progress) have full
