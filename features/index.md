...
| 26 | It fits the screen (no menu off the edge, no sideways scroll, a row that breathes on a phone) | [`it-fits-the-screen`](./it-fits-the-screen/description.md) | **Implemented** (2026-09-17; all 3 tasks merged, #234 + #235 + #236; awaiting the phone check, #229) | #8, #9, #10, #16, #19 |
