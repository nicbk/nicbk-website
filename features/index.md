...
| 10 | Citation-graph traversal (a Citations tab: what a paper cites and what cites it, followed from paper to paper with a short way back) | [`citation-graph-traversal`](./citation-graph-traversal/description.md) | **In progress** (2026-09-14; 5 tasks; task 1 merged, task 2 in review) | #7, #9, #23 |
